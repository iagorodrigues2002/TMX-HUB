...
export function RefundsDashboard() {
  ...
  const unclassifiedVendepays = vendepays.filter((item) => item.connection_name !== 'VendePay Iago' && item.connection_name !== 'VendePay Lucas' && item.count > 0);
